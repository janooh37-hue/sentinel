...
def test_parse_tickets_payload_maps_rows_and_skips_unusable() -> None:
    assert parse_tickets_payload(TICKETS_PAYLOAD) == [
        EvgTicketRow(
            ...
            amount_fils=60040,
            discount_pct=10,
            amount_after_discount_fils=54060,
            late_charges=21,
            black_points=4,
            fine_type="Absent",
            descriptions=(
...
def _ticket(
    ...
    *,
    ...
    return EvgTicketRow(
        ...
        amount_fils=amount * 100,
        discount_pct=0,
        amount_after_discount_fils=(
            amount_after_discount * 100 if amount_after_discount is not None else None
        ),
        late_charges=0,
...
def _confirm_payload(
    ...
    **overrides: object,
    ...
    payload: dict[str, object] = {
        ...
        "plate_code": "21",
        "amount_fils": 60000,
        "amount_after_discount_fils": 60000,
        "black_points": 0,
        "fine_type": "Absent",
...
def evg_fleet(db_session: Session, admin_user: User) -> dict[str, object]:
    ...
    imported = VehicleFine(
        ...
        date=date(2026, 8, 1),
        amount_fils=40000,
        amount_after_discount_fils=40000,
        black_points=0,
        source="evg",
        evg_ticket_no="9004",
...
def test_preview_returns_accepted_while_fetch_is_blocked_then_imports(
    ...
    try:
        ...
        assert fines[0]["amount_fils"] == 60000
...
def test_confirm_inserts_two_skips_duplicate_and_preserves_evg_fields(
    ...
    matched = EvgConfirmRow(
        ...
        plate_code="21",
        amount_fils=60000,
        amount_after_discount_fils=54000,
        black_points=4,
        fine_type="Absent",
    ...
    assigned_ambiguous = EvgConfirmRow(
        ...
        plate_code=None,
        amount_fils=30000,
        amount_after_discount_fils=27000,
        black_points=0,
        fine_type="Absent",
    ...
    assert (
        ...
        first.time,
        first.amount_fils,
        first.amount_after_discount_fils,
        first.black_points,
        first.location,
        first.description,
        first.fine_type,
    ...
    assert (
        ...
        second.time,
        second.amount_fils,
        second.amount_after_discount_fils,
        second.black_points,
        second.location,
        second.description,
    ) == (
...
def test_confirm_rejects_an_unmatched_row_before_any_insert(
    ...
    valid = EvgConfirmRow(
        ...
        plate_code="21",
        amount_fils=50000,
        amount_after_discount_fils=50000,
        black_points=0,
        fine_type="Absent",
