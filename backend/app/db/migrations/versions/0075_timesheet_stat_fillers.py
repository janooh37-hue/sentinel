...
Revision ID: 0075_timesheet_stat_fillers
Revises: 0074_employee_supervisor
...
revision: str = "0075_timesheet_stat_fillers"
down_revision: str | Sequence[str] | None = "0074_employee_supervisor"
