...
def download_document(
    ...
    if original:
        ...
        return FileResponse(
            path=str(orig_path),
            media_type="application/pdf",
            filename=document_service.download_filename_for(row, ".pdf", db=db, version=version),
    ...
    filename = document_service.download_filename_for(row, ext, db=db, version=version)
