 ...
 * reading-pane slot). The reading pane is `outlook/ReadingPane`; email handoffs
 * use `OutlookHandoffDialog`. This page stays a thin host so the smart-link nav
 * callbacks (`openEmployee`/`openBook`) are owned at the page level and threaded
 * into the shell.
 */
