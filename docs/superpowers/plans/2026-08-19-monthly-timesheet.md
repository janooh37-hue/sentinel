...
- Exactly one Alembic head. Migration `0070_timesheet` is already applied. Task 3 adds `0071_timesheet_stat_fillers` and `0072_timesheet_start_acks`, in that order; no other migration.
...
| `backend/app/db/migrations/versions/0072_timesheet_start_acks.py` (create) | Starting-point acknowledgements for mid-month joiners |
...
- Create: `backend/app/db/migrations/versions/0072_timesheet_start_acks.py`
...
Expected: exactly one head, `0072_timesheet_start_acks`.
...
Expected: 25 tests PASS; exactly one head, `0072_timesheet_start_acks`.
...
```bash
git add backend/app/services/timesheet_service.py backend/app/db/models.py backend/app/db/migrations/versions/0071_timesheet_stat_fillers.py backend/app/db/migrations/versions/0072_timesheet_start_acks.py backend/app/main.py backend/tests/test_timesheet_service.py
